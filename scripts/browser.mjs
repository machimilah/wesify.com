 ...
 *
 * Every build begins with two questions — a name, a logo — asked by the assistant in the build
 * thread itself rather than by a dialog in front of it. Only the name needs typing; the logo takes
 * the Skip button beside it. It lives here rather than in six copies for the usual reason: when the
 * intake gains a question, one file changes.
 */
export async function passOnboarding(page, name = 'Test Company') {
  ...
  // The logo, skipped from the button beside the question.
