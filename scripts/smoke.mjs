...
try {
  ...
  if (await page.getByText("Don't pay for what you don't need", { exact: true }).count() !== 1) throw new Error('The home-page title is missing.')
  if (await page.getByText('Describe how your company works. Wesify creates the workplace you need.', { exact: true }).count() !== 1) throw new Error('The home-page explanation is missing.')
