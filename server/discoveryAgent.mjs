...
What you return is the whole workspace. Nothing is added afterwards for the industry you think this is — no stock control because it sounded like a shop, no invoicing because most businesses invoice, no team directory because most businesses have staff. If somebody described a way of keeping track of their school work, the answer is their assignments and their classes, and it is finished. If somebody described a workshop that buys clay and posts parcels, then products, stock and shipping all belong, because they said so. Both of those are the same instruction: build what this person described, at the size they described it.
