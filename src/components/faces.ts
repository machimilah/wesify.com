...
export const moduleFace: Record<string, { icon: typeof LayoutDashboard; tint: string }> = {
  ...
  subscriptions: { icon: RefreshCw, tint: 'teal' },
  ...
  procurement: { icon: ClipboardList, tint: 'olive' },
  inventory: { icon: Boxes, tint: 'olive' },
  manufacturing: { icon: Factory, tint: 'slate' },
  quality: { icon: BadgeCheck, tint: 'green' },
  maintenance: { icon: Wrench, tint: 'slate' },
  logistics: { icon: Truck, tint: 'teal' },
  finance: { icon: CircleDollarSign, tint: 'green' },
  accounting: { icon: BookOpen, tint: 'green' },
  ...
  payroll: { icon: Banknote, tint: 'green' },
