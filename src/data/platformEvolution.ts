...
export const sourceMappings: SourceMappingEntry[] = [
  ...
  { id: 'knowledge-gaps', sourceConcept: 'Diagnostic knowledge requirements', principle: 'Unknown facts must remain explicit.', disposition: 'use-directly', platformPrimitive: 'Typed gaps, confidence and exclusions', implementationRefs: ['src/engine/knowledgeEngine.ts', 'src/data/operatingKnowledge.ts'], userCapability: 'Sees what BO still needs to know and why.', rationale: 'Prevents guesses from silently becoming configuration.' },
