/**
 * Wesify's API, as a Vercel function.
 *
 ...
 *
 * A catch-all rather than a file per route, because Wesify already has a router: `handleRequest` takes
 ...
 *   Wesify writes generated Command Centers there, so `DATABASE_URL` stops being optional here: records,
 ...
 * - Each invocation is its own process. Anything Wesify keeps in memory — rate-limit counters, the note
